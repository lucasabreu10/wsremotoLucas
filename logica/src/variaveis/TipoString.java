...
public class TipoString {
	...
	public static void main(String[] args) {
		...
		System.out.println("É igual: " + email.equals("lUcAsAbrEU@hotmail.com"));
		System.out.println("É igual: " + email.equalsIgnoreCase("lucasabreu@hotmail.com"));
		System.out.println("Contém: " + email.contains("@"));
		System.out.println("Posiçãod o @: " + email.indexOf("@"));
